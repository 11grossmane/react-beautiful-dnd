	...
	*/
	...
	function useTouchSensor(args) {
	  var callbacks = args.callbacks,
	      ...
	      onCaptureStart = args.onCaptureStart,
	      onCaptureEnd = args.onCaptureEnd,
	      longPressTimeout = args.longPressTimeout;
	  var pendingRef = React.useRef(null);
	  var isDraggingRef = React.useRef(false);
	  ...
	  var startPendingDrag = useCallback(function (event) {
	    ...
	    var longPressTimerId = setTimeout(startDragging, longPressTimeout);
	    var pending = {
	      point: point,
	...
	function useDragHandle(args) {
	  ...
	  }, [callbacks, getDraggableRef, getWindow, canStartCapturing, getShouldRespectForcePress, onCaptureStart, onCaptureEnd, longPressTimeout]);
	...
	function Draggable(props) {
	  ...
	  var children = props.children,
	      ...
	      longPressTimeout = props.longPressTimeout,
	  ...
	  }, [callbacks, canDragInteractiveElements, draggableId, getRef, getShouldRespectForcePress, isDragDisabled, isDragging, isDropAnimating, longPressTimeout]);
